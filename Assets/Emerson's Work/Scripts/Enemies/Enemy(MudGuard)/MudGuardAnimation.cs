...
public class MudGuardAnimation : MonoBehaviour, ICharacterAnimations, IEnemyFunctions, ICharacterSounds
{
    //player Animator
    ...
    public void destroyObj()
    {
        ...
        Destroy(this.transform.parent.gameObject, GeneralAnimationProperty.mud_dead_delay);
    }
    public bool getAnimationState(int index)
    {
        return this.enemyAnim.GetCurrentAnimatorStateInfo(index).IsName("enemy1_attack");
    }
